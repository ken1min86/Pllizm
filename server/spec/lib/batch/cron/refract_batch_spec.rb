  ...
  and have refract candidate" do
    before do
      travel_to Time.zone.local(2021, 8, 27) do
        ...
        @follower_of_user1 = create_mutual_follow_user(@user1)
        create_mutual_follow_user(@user1)
        @follower_of_user2 = create_mutual_follow_user(@user2)
        create_mutual_follow_user(@user2)
  ...
  and has refract candidate" do
    before do
      travel_to Time.zone.local(2021, 8, 27) do
        ...
        @follower_of_user = create_mutual_follow_user(@user)
        create_mutual_follow_user(@user)
