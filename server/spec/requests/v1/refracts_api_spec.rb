...
RSpec.describe "V1::RefractsApi", type: :request do
  describe "GET /v1/refracts/perform - v1/refracts#perform_refract - Perform refract" do
    context "when client doesn't have token" do
      ...
      it "returns 401" do
        post v1_refract_performed_path(refract_candidate_id: client_user_post.id)
