# -*- encoding: utf-8 -*-
# stub: nokogiri 1.12.4 x86_64-darwin lib
...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["ext/nokogiri/xml_dtd.c".freeze, "ext/nokogiri/xml_xpath_context.c".freeze, "ext/nokogiri/xml_attr.c".freeze, "ext/nokogiri/libxml2_backwards_compat.c".freeze, "ext/nokogiri/xml_comment.c".freeze, "ext/nokogiri/nokogiri.c".freeze, "ext/nokogiri/xml_sax_parser_context.c".freeze, "ext/nokogiri/xml_node_set.c".freeze, "ext/nokogiri/xml_reader.c".freeze, "ext/nokogiri/html4_document.c".freeze, "ext/nokogiri/xml_cdata.c".freeze, "ext/nokogiri/html4_entity_lookup.c".freeze, "ext/nokogiri/xml_element_content.c".freeze, "ext/nokogiri/html4_sax_push_parser.c".freeze, "ext/nokogiri/xml_namespace.c".freeze, "ext/nokogiri/html4_sax_parser_context.c".freeze, "ext/nokogiri/xml_document.c".freeze, "ext/nokogiri/xml_element_decl.c".freeze, "ext/nokogiri/xml_schema.c".freeze, "ext/nokogiri/xml_processing_instruction.c".freeze, "ext/nokogiri/xml_text.c".freeze, "ext/nokogiri/xml_syntax_error.c".freeze, "ext/nokogiri/xml_document_fragment.c".freeze, "ext/nokogiri/xml_sax_push_parser.c".freeze, "ext/nokogiri/xml_encoding_handler.c".freeze, "ext/nokogiri/xml_relax_ng.c".freeze, "ext/nokogiri/xml_entity_decl.c".freeze, "ext/nokogiri/test_global_handlers.c".freeze, "ext/nokogiri/xml_node.c".freeze, "ext/nokogiri/xml_entity_reference.c".freeze, "ext/nokogiri/xslt_stylesheet.c".freeze, "ext/nokogiri/html4_element_description.c".freeze, "ext/nokogiri/xml_sax_parser.c".freeze, "ext/nokogiri/xml_attribute_decl.c".freeze, "ext/nokogiri/gumbo.c".freeze, "README.md".freeze]
