# -*- encoding: utf-8 -*-
# stub: rspec-rails 5.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.10"])
    s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.10"])
    s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.10"])
    s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.10"])
    ...
    s.add_dependency(%q<rspec-core>.freeze, ["~> 3.10"])
    s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.10"])
    s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.10"])
    s.add_dependency(%q<rspec-support>.freeze, ["~> 3.10"])
