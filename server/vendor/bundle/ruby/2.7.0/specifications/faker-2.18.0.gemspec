...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["= 1.14.0"])
    s.add_development_dependency(%q<simplecov>.freeze, ["= 0.17.1", "< 0.18"])
    s.add_development_dependency(%q<test-unit>.freeze, ["= 3.4.1"])
    ...
    s.add_dependency(%q<test-unit>.freeze, ["= 3.4.1"])
