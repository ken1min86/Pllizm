# -*- encoding: utf-8 -*-
# stub: fog-storm_on_demand 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "fog-storm_on_demand".freeze
  s.version = "0.1.1"
