# -*- encoding: utf-8 -*-
# stub: rubocop-performance 1.10.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rubocop>.freeze, [">= 0.90.0", "< 2.0"])
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 0.4.0"])
  else
    s.add_dependency(%q<rubocop>.freeze, [">= 0.90.0", "< 2.0"])
