...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/whitequark/parser/issues", "changelog_uri" => "https://github.com/whitequark/parser/blob/v3.0.2.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/parser/3.0.2.0", "source_code_uri" => "https://github.com/whitequark/parser/tree/v3.0.2.0" } if s.respond_to? :metadata=
