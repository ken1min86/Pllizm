...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<appraisal>.freeze, [">= 2.3.0", "~> 2.3"])
    s.add_development_dependency(%q<rspec>.freeze, [">= 3.9.0", "~> 3.9"])
    s.add_development_dependency(%q<bootsnap>.freeze, ["~> 1.4"])
    s.add_development_dependency(%q<rails>.freeze, ["= 6.0.3.1"])
    s.add_development_dependency(%q<rspec-rails>.freeze, ["~> 3.7"])
    s.add_development_dependency(%q<mdl>.freeze, [">= 0.9.0", "~> 0.9"])
    ...
    s.add_dependency(%q<appraisal>.freeze, [">= 2.3.0", "~> 2.3"])
    ...
    s.add_dependency(%q<mdl>.freeze, [">= 0.9.0", "~> 0.9"])
