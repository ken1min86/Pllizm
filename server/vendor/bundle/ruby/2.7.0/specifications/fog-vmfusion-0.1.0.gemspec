# -*- encoding: utf-8 -*-
# stub: fog-vmfusion 0.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "fog-vmfusion".freeze
  s.version = "0.1.0"
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<fission>.freeze, [">= 0"])
