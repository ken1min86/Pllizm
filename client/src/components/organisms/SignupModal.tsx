import { BasicTextField, BlueRoundedCornerButton, BlueSquareButton, ErrorMessages } from 'components/atoms'
...
const SignupModal: VFC<Props> = ({ type }) => {
  ...
  return (
    <>
      ...
      >
        {type === 'button' && <BlueRoundedCornerButton label="会員登録" onClick={openModal} />}
        {type === 'text' && (
      ...
      <Modal isOpen={modalIsOpen} onRequestClose={closeModal} className={classes.content} contentLabel="Example Modal">
